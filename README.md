# SnagTin — Phần mềm chụp màn hình, thư viện & vẽ chú thích
...
4. **Recording** — **quay video màn hình** (vùng chọn hoặc toàn màn) xuất MP4 (H.264), tùy chọn **quay kèm âm thanh micro**.
...
| `Ctrl+Shift+R` | Bật/tắt quay video (chọn vùng) |
...
- **Quay video**: `Ctrl+Shift+R` (hoặc menu khay) → kéo chọn vùng → thanh điều khiển nổi hiện ra với **Tạm dừng / Dừng** và đồng hồ. Dừng xong video tự lưu vào thư viện.
...
File kết quả: `dist\SnagTin.exe` (chạy độc lập, không cần cài Python).
